    ...
    <div class="row">
        <div class="card shadow mb-4 col-sm-12">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Categories List</h6><br>
                        ...
                        <?php if(!empty($categories)){
                            ...
                            foreach($categories as $one) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $this->inventory_model->categoryproductstotal($one['id']);?></td>
                                    <td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url();?>inventory/categories" method="post">
                    <div class="row">
...
<script>
    $('.edit').click(function(){
        ...
        var url = "<?php echo base_url();?>" + "inventory/viewcategory/" + id;
        var editurl =  "<?php echo base_url();?>" + "inventory/editcategory/" + id;
        $.ajax({
            type: "GET",
            url: url,
            dataType: "json",
    ...
    $('.delete').click(function(){
        var del = confirm("Are you sure you want to delete this Category? NB: All the associated data i.e products, invoices etc will be deleted too!");
        if (del == true) {
            var id = $(this).attr("data-id");
            var url = "<?php echo base_url();?>" + "inventory/deletecategory/" + id;
            $.ajax({
                type: "GET",
                url: url,
                dataType: "json",
